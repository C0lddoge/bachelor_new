...
def return_name_md(N1 = '256', N2 = '256', dens = '0.025',types=[0,0]):
    return 'RP_N{:},{:}_rho{:}_rdf_{:}{:}.dat'.format(N1,N2,dens,*types)
...
dens = ['0.0002787','0.0002787','0.000418','0.000418','0.0005574','0.0005574']
